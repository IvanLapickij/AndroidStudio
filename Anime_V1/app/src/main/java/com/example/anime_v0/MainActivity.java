...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.btu_voice) {
            Toast.makeText(this, "Text to voice", Toast.LENGTH_SHORT).show();
            Intent myIntent = new Intent(MainActivity.this, MainActivity9_TextToSpeach.class);
            MainActivity.this.startActivity(myIntent);
            return true;
        }
        if (id == R.id.btu_countTime) {
            Toast.makeText(this, "Count Time", Toast.LENGTH_SHORT).show();
            Intent myIntent = new Intent(MainActivity.this, MainActivity10_CountDownTimer.class);
            MainActivity.this.startActivity(myIntent);
            return true;
        }
        if (id == R.id.btu_random123) {
        Toast.makeText(this, "Random Image", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(MainActivity.this, MainActivity11_Random.class);
        MainActivity.this.startActivity(myIntent);
        return true;
        }
        if (id == R.id.btu_12) {
            Toast.makeText(this, "Inflater", Toast.LENGTH_SHORT).show();
            Intent myIntent = new Intent(MainActivity.this, MainActivity12_Inflater.class);
            MainActivity.this.startActivity(myIntent);
            return true;
    }
